...
st.success("Input context from [Kaggle Notebook](https://www.kaggle.com/code/kushtrivedi14728/noise-to-decision-with-bigquery-ai) → Ticker: AAPL | Keywords: 'apple, iphone, ipad, macbook, tim cook' | Date: 2025-08-08 or auto (latest available)")
...
with st.container(border=True):
    st.subheader(":green[Signal] :violet[Snapshot] Generated by :blue[BigQuery AI]")
